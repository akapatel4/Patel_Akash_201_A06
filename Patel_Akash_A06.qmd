...
[https://github.com/akapatel4/Patel_Akash_201_A06](https://github.com/akapatel4/Patel_Akash_201_A06)
...
```{r}
LBJ_points = player_info[[2]][[4]]
print(LBJ_points)
Lebron_points = player_info[["LJ"]][["points"]]
print(Lebron_points)
```
...
```{r}
player_heights = c(MJ = 78, LJ = 81, KB = 78, KA = 86, SO = 85)
player_info$MJ$height = player_heights[["MJ"]]
player_info$LJ$height = player_heights[["LJ"]]
player_info$KB$height = player_heights[["KB"]]
player_info$KA$height = player_heights[["KA"]]
player_info$SO$height = player_heights[["SO"]]
print(player_info)
```
...
mat_round = apply(mat_rand, MARGIN = 1:2, round_digits)
print(mat_rand)
print(mat_round)
```
...
```{r}
average_temp = list()
average_temp = colMeans(max_temps[, 3:14])
print(average_temp)
...
```{r}
digits_sum = function(input){
  if(input<10){
    return(0)
  }else{
    return(input%%10 + digits_sum(input%%10))
  }
}
digits_sum(935068)
```
